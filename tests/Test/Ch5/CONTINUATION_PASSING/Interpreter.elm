module Test.Ch5.CONTINUATION_PASSING.Interpreter exposing (suite)

import Ch5.CONTINUATION_PASSING.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch3.CONTINUATION_PASSING.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
