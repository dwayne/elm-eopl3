module Test.Ch4.CALL_BY_REFERENCE.Interpreter exposing (suite)

import Ch4.CALL_BY_REFERENCE.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch4.CALL_BY_REFERENCE.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
