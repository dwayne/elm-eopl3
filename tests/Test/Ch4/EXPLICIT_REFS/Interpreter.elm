module Test.Ch4.EXPLICIT_REFS.Interpreter exposing (suite)

import Ch4.EXPLICIT_REFS.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch4.EXPLICIT_REFS.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
