module Test.Ch4.MUTABLE_PAIRS.Interpreter exposing (suite)

import Ch4.MUTABLE_PAIRS.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch4.MUTABLE_PAIRS.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
