module Test.Ch4.CALL_BY_NAME.Interpreter exposing (suite)

import Ch4.CALL_BY_NAME.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch4.CALL_BY_NAME.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
