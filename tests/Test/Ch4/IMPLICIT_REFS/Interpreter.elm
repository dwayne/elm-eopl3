module Test.Ch4.IMPLICIT_REFS.Interpreter exposing (suite)

import Ch4.IMPLICIT_REFS.Interpreter as I exposing (Value(..))
...
suite : Test
suite =
    describe "Ch4.IMPLICIT_REFS.Interpreter" <|
        List.map testValue
            [ ( "5"
              , VNumber 5
              )
